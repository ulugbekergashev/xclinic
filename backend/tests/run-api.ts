...
const SUITES = ['permissions', 'consistency', 'icd10', 'attendance', 'license', 'templates', 'scheduling', 'staff', 'hr', 'expiry', 'validation', 'visitclose', 'payments', 'moneybugs', 'stock', 'patients', 'events', 'money', 'integrity'];
