...
const SUITES = ['permissions', 'consistency', 'icd10', 'attendance', 'templates', 'scheduling', 'expiry', 'validation', 'visitclose', 'payments', 'moneybugs', 'stock', 'patients', 'events', 'money', 'integrity'];
